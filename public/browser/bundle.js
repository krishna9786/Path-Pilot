  ...
  if (!this.buttonsOn) {
    ...
    document.getElementById("startButtonBidirectional").onclick = () => {
      ...
      if (this.numberOfObjects) {
        ...
        document.getElementById("startButtonAddObject").innerHTML = '<a href="#">Add a Node</a></li>';
    ...
    document.getElementById("startButtonClearBoard").onclick = () => {
      document.getElementById("startButtonAddObject").innerHTML = '<a href="#">Add Node</a></li>';
      ...
      if (this.currentAlgorithm !== "bidirectional") {
        if (innerHTML.includes("Add")) {
          ...
          if (this.target === objectNodeId || this.start === objectNodeId || this.numberOfObjects === 1) {
            ...
            document.getElementById("startButtonAddObject").innerHTML = '<a href="#">Remove Node</a></li>';
            this.clearPath("clickedButton");
